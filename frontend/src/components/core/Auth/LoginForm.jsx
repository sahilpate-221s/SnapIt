...
//     <form onSubmit={handleOnSubmit} className="flex flex-col space-y-4">
//       <label className="w-full">
//         <p className="mb-1 text-[0.875rem] text-gray-800">
//           Email Address <sup className="text-red-300">*</sup>
//         </p>
//         <input
//           type="email"
...
//           onChange={handleOnChange}
//           placeholder="Enter your email address"
//           className="w-full rounded-lg bg-white p-3 text-black border border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-800"
//         />
//       </label>
...
//         type="submit"
//         disabled={submitting}
//         className="w-full py-3 px-6 rounded-lg text-white font-semibold bg-gradient-to-r from-gray-300 to-gray-900 hover:from-black hover:to-gray-500 shadow-lg transition-all disabled:opacity-60"
//       >
