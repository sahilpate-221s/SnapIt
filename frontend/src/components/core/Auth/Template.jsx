...
//         <p className="mb-6 text-center text-sm">{description}</p>
...
function Template({ title, description, formType }) {
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center z-50 sm:mx-6 md:mx-0">
      <div
        ref={modalRef}
        className="bg-white p-6 rounded-lg shadow-lg
                   max-w-lg w-full
                   sm:max-w-md sm:mx-6 md:mx-0 lg:mx-0"
      >
        <h2 className="md:text-2xl sm:text-sm font-semibold mb-3 font-diphylleia text-center">
          {title}
        </h2>
