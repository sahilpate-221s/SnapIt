...
export const collectionEndpoints = {
    NEW_COLLECTION_API: BASE_URL + "/collection/createCollection",
    ALL_COLLECTIONS_API: BASE_URL + "/collection/all-Collections",
    ADD_POST_TO_COLLECTION_API: (collectionId) => `${BASE_URL}/collection/${collectionId}/posts`,
    REMOVE_POST_FROM_COLLECTION_API: BASE_URL + "/collection/delete-posts",
